                ...
                {typingUsers && typingUsers.length > 0
                    ? (<div className="conversations-list-info">
                        <figure className="image is-96x96">
                            <img className="is-rounded" src={`/${typingUsers[0].avatar}`} alt={`${typingUsers[0].fullName}'s avatar`} />
                        </figure>
                    ...
                    : (<div className="conversations-list-info">
                        <figure className="image is-96x96">
                            <img className="is-rounded" src={`/${interlocutor.avatar}`} alt={`${interlocutor.fullName}'s avatar`} />
                        </figure>
